...
\usepackage[style=custom-alphabetic-verb, url=true, dateabbrev=false]{biblatex}
...
\DeclareBibliographyDriver{online}{%
  ...
  \space
  von\addcolon\
  \settowidth{\fieldlength}{\printfield{url}}
  \ifthenelse{\fieldlength>\urlbreaklength}{\newline}{}
  \printfield{url}
  \addcomma\space
  \printlist{location}%
  \newunit\newblock
...
\DeclareFieldFormat[online]{url}{\href{#1}{#1}}
